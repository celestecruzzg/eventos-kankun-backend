        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngresosGenerados = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Cancelaciones = table.Column<int>(type: "int", nullable: false),
                    Ausencias = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MetricasEventos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MetricasEventos_Eventos_EventoId",
                        column: x => x.EventoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequerimientosEspeciales = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MetricasEventos_EventoId",
                table: "MetricasEventos",
                column: "EventoId");
